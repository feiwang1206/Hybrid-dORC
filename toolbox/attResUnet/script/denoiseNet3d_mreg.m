...
scale=2;
dataFolder = ['/home/ubuntu/Documents/work/train/dataset/simu_fbu_modl_fista13_image_diff3d32/labelsTra'];
...
if doTraining
    ...
    save('/home/ubuntu/Documents/work/train/diffisionnet/nnet/GenerateImagesUsingDiffusionExample/denoisenet3d32_200.mat',"net");
else
    load('/home/ubuntu/Documents/work/train/diffisionnet/nnet/GenerateImagesUsingDiffusionExample/denoisenet3d32_200.mat',"net");
end
%%
numImages = 1;
displayFrequency = 10;
...
% Generate random noise.
images(:,:,:,1) = gpuArray(randn([imageSize 1 numImages]));
images(:,:,:,2) = gpuArray(randn([imageSize 1 numImages]));
