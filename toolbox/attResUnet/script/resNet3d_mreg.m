...
if doTraining
    ...
    save('/home/ubuntu/Documents/work/train/diffisionnet/nnet/GenerateImagesUsingDiffusionExample/net/resnet3d32_mreg.mat',"net");
else
    load('/home/ubuntu/Documents/work/train/diffisionnet/nnet/GenerateImagesUsingDiffusionExample/net/resnet3d32_mreg.mat',"net");
end
%%
numDownSampSteps=3;
imgSize=[32 32 24];
...
figure
tic;generatedImages2 = generateAndDisplayImages2(net,Img,param,numDownSampSteps,imgSize,1);toc
%%
...
%     end
% end
images=applyDownSampToImage(Img,2^numDownSampSteps)+1i*applyDownSampToImage(Img,2^numDownSampSteps);
