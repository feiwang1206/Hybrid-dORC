...
if doTraining
    ...
    save('/home/ubuntu/Documents/work/train/diffisionnet/nnet/GenerateImagesUsingDiffusionExample/net/denoiseNet2d_cmr_200.mat',"net");
else
    load('/home/ubuntu/Documents/work/train/diffisionnet/nnet/GenerateImagesUsingDiffusionExample/net/denoiseNet2d_cmr_200.mat',"net");
end
%%
numImages = 1;
displayFrequency = 10;
...
displayFrequency = 10;
figure
tic;generatedImages2 = generateAndDisplayImages2(net,gpuArray(noisyImg),varianceSchedule,imgSize,numImages,numInputChannels,displayFrequency);toc
%%
numImages = 1;
displayFrequency = 10;
figure
tic;generatedImages3 = generateAndDisplayImages3(net,Img,(mask),varianceSchedule,imgSize,numImages,numInputChannels,displayFrequency);toc
%%
