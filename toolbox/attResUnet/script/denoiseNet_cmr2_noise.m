...
if doTraining
    % net = createDiffusionNetwork(numInputChannels);
     load('/home/ubuntu/Documents/work/train/diffisionnet/nnet/GenerateImagesUsingDiffusionExample/net/deartefactNet2d_cmr_iter_noise.mat',"net");
    ...
    save('/home/ubuntu/Documents/work/train/diffisionnet/nnet/GenerateImagesUsingDiffusionExample/net/deartefactNet2d_cmr_iter_noise.mat',"net");
else
    load('/home/ubuntu/Documents/work/train/diffisionnet/nnet/GenerateImagesUsingDiffusionExample/net/deartefactNet2d_cmr_iter_noise.mat',"net");
end
%%
...
for noiseStep = (numsteps):-1:1
    ...
    loss(numsteps-noiseStep+1)=l2norm(Img_clean-Img_degrade);
    % printf(['loss:' num2str(loss)])
    ...
    for ii = 1:1
        ...
        imagesc(abs(complex(Img_degrade(:,:,1,ii),Img_degrade(:,:,2,ii))))
    end
    drawnow
end
