function net = createDiffusionNetwork3d2(imagesize,numImageChannels)
...
layers = [
    ...
    convolution3dLayer(filterSize,4*initialNumChannels,'Padding',"same",'Stride',2,'Name',"downsample_2")
    ...
    transposedConv3dLayer(filterSize,2*initialNumChannels,'Cropping',"same",'Stride',2,'Name',"upsample_5")
    ...
    transposedConv3dLayer(filterSize,initialNumChannels,'Cropping',"same",'Stride',2,'Name',"upsample_6")
