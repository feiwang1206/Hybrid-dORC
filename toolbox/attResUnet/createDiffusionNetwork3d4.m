function net = createDiffusionNetwork3d4(imagesize,numImageChannels)
...
layers = [
    ...
    % Bridge
    residualBlock(1*initialNumChannels,filterSize,numGroups,"2")
    attentionBlock(numHeads,1*initialNumChannels,numGroups,"2",imagesize/1)

    % Decoder

    depthConcatenationLayer(2,'Name',"cat_3")
    residualBlock(initialNumChannels,filterSize,numGroups,"3")
