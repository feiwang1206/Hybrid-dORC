function net = createDiffusionNetwork2d_train(imagesize,inputChannels,outputChannels)
...
layers = [
    ...
    swishLayer
    convolution2dLayer(filterSize,outputChannels,'Padding',"same");
...
layers = [
    ...
    SpatialFlattenLayer('Name',"flatten"+name)
    selfAttentionLayer(numHeads,numKeyChannels)
    SpatialUnflattenLayer('Name',"unflatten"+name)
