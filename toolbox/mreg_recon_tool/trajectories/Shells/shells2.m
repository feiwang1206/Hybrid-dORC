function T=shells2(R,fov,resolution,TE,Npolar,Nradial,varargin)
...
for iradial =1:Nradial
    for ipolar=1:Npolar
        ...
        for l=2:length(T(:,ipolar,iradial))
            Tc(ipolar,iradial) = trajectStruct_connect(Tc(ipolar,iradial),trajectStruct_rotate(T(l,ipolar,iradial),alpha,[0 0 1]));
        end
    end
end
