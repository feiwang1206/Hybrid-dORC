...
if linear_flag==0 % use nonlinear conjugate gradient
    ...
    if nargout==1
        [z] = nonlinearConjugateGradient_old(f,df,z0,tol,maxit,cg_method,verbose_flag,reference_norm);
    else
        [z, z_iter] = nonlinearConjugateGradient_old(f,df,z0,tol,maxit,cg_method,verbose_flag,reference_norm);
    end
