function  s = orc_segm_nuFTOperator_structure_sub(trajectory, imageDim, imageDim2,sensmaps, dwelltime, Ns, T,lambda)
...
s.oversampling = s.imageDim*1;
s.oversampling2 = s.imageDim2*1;
s.nSegments = Ns;
...
s.sensmaps_scale = bsxfun(@times,imresize3D(s.scaling_factor,s.imageDim2),sensmaps);
