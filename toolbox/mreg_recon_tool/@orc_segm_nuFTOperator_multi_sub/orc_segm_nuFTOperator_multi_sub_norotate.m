function  A = orc_segm_nuFTOperator_multi_sub_norotate(trajectory, imageDim, sensmaps, wmap,  dwelltime, Ns, T)
...
A = class(s,'orc_segm_nuFTOperator_multi_sub_norotate');
