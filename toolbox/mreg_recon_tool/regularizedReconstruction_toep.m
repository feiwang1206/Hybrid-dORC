function [z, z_iter] = regularizedReconstruction_toep(S,b,varargin)
...
%     q = A'*b;
    ...
    if nargout==1
        z = conjugateGradient(S,b,tol,maxit,z0,verbose_flag,newfigure);
    else
        [z,z_iter] = conjugateGradient(S,b,tol,maxit,z0,verbose_flag,newfigure);
    end    
end
